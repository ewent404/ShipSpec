...
Active change: Add no-copy Codex handoff
...
- openspec/changes/add-no-copy-codex-handoff/proposal.md
- openspec/changes/add-no-copy-codex-handoff/tasks.md
- .gsd/reasoning/add-no-copy-codex-handoff.md
